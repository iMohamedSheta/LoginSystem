...
<div class="row py-5 px-4 " dir="rtl">
            ...
            <div class="px-4 pt-5 pb-5 bg-dark profile-cover">
                <div class="media align-items-end profile-header">
                    <div class="profile mr-3">
                        ...
                        <a href="../profile-edit" class="btn btn-dark btn-sm btn-block">تعديل البيانات</a>
                    </div>
...
<div class="row bio">
    ...
    <div class="col-xl-6 col-md-9 col-sm-12 mx-auto" style="position:relative; left:60%;">
